...
public class query2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.query2, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        authorName.addTextChangedListener(new TextWatcher() {
            public void afterTextChanged(Editable s) {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.GET, MainActivity.serverURL_query2 + "?auth_name=" + text.trim(),
